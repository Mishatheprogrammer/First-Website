...
class AccountAdmin(UserAdmin):
    ...
    list_display_links = ('email', 'username', 'first_name', 'last_name') # This will make the email and username clickable in the admin panel

    readonly_fields = ('last_login', 'date_joined') # This will make the last login and date joined Read-Only in the admin panel

    ordering = ('-date_joined',)

    search_fields = ('email', 'username', 'first_name', 'last_name') # This will make the search bar in the admin panel
    filter_horizontal = ()
